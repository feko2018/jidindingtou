...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 4:
        print("Usage:python3 jijindingtou.py 基金代号 开始日期 结束日期")
        print("Usage:python3 jijindingtou.py 012414  2021-01-01 2021-12-31")
        sys.exit()
    else:
        code = sys.argv[1]  ##基金代号
        start_date = sys.argv[2]  ##开始日期
        end_date = sys.argv[3]  ##接受日期
